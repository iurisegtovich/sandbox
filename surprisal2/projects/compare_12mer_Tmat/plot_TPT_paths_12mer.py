...
def plot_landscape(TPTdir, unfolded_state=0, UseLabels=False, UseNewArrows=True):
...
if __name__ == '__main__':
    ...
    plot_landscape(TPTdir1, unfolded_state=0)

    ###############################
    # Panel B 
    ax = plt.axes(f.axis_handles[1])
    plot_landscape(TPTdir2, unfolded_state=0)
