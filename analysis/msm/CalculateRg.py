...
if __name__ == '__main__':
    ...
    parser.add_argument('-p','--ProjectInfo',help="""Path to ProjectInfo.h5 file""",required=True)
    ...
    if args.Trajlikefile == None:
        CalculateProjectRg(ProjectInfo=args.ProjectInfo,Output=args.Output,returnRgs = False)
    else:
